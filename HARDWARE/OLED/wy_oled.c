...
*@Func:	设置坐标地址
******
*@para:	x:0~127		y:0~63		t:1 填充 0,清空
******
*@desc:
******************************************************/
...
******
*@desc:	确保x1<=x2;y1<=y2 0<=x1<=127 0<=y1<=63
******************************************************/
...
void OLED_Init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_OLED_SCLK_Pin | GPIO_OLED_PIN_Pin | GPIO_OLED_RES_Pin | GPIO_OLED_DC_Pin; //推挽输出
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;			//推挽输出
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;			//速度50MHz
    GPIO_Init(GPIOC, &GPIO_InitStructure);	  					//初始化GPIOC0/1/2/3
    GPIO_SetBits(GPIOC, GPIO_OLED_SCLK_Pin | GPIO_OLED_PIN_Pin | GPIO_OLED_RES_Pin | GPIO_OLED_DC_Pin);		 //输出高
