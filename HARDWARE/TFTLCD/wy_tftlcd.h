...
#define BRED_             0XF81F
#define GRED_ 			 0XFFE0
#define GBLUE_			 0X07FF
#define RED_           	 0xF800
#define MAGENTA_       	 0xF81F
#define GREEN_         	 0x07E0
#define CYAN_          	 0x7FFF
#define YELLOW_        	 0xFFE0
#define BROWN_ 			 0XBC40 //棕色
#define BRRED_ 			 0XFC07 //棕红色
#define GRAY_  			 0X8430 //灰色
//GUI颜色
...
void LCD_SetWordColor(u16 LineColor, u16 BackColor);						//设置字体颜色
...
void LCD_ShowChar(u16 x,u16 y,u8 ch,u8 size,u8 mode);						//显示一个字符
void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size);  						//显示一个数字
void LCD_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode);				//显示 数字
void LCD_ShowString(u16 x,u16 y,u16 width,u16 height,u8 size,char *p);		//显示一个字符串,12/16字体
void LCD_ShowFloat(u16 x,u16 y,u16 width,u16 height,u8 size, float LCD_Float);//显示整型数据
void LCD_ShowInt(u16 x,u16 y,u16 width,u16 height,u8 size, int LCD_Int);	//显示浮点型数据
